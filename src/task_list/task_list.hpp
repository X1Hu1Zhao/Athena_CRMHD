...
class TimeIntegratorTaskList : public TaskList {
 public:
  ...
  TaskStatus CalculateCosmicRayFlux(MeshBlock *pmb, int stage);
  TaskStatus SendCosmicRayFlux(MeshBlock *pmb, int stage);
  TaskStatus ReceiveAndCorrectCosmicRayFlux(MeshBlock *pmb, int stage);
  TaskStatus IntegrateCosmicRay(MeshBlock *pmb, int stage);
  TaskStatus AddSourceTermsCosmicRay(MeshBlock *pmb, int stage);
  TaskStatus SendCosmicRay(MeshBlock *pmb, int stage);
  TaskStatus ReceiveCosmicRay(MeshBlock *pmb, int stage);
  TaskStatus SetBoundariesCosmicRay(MeshBlock *pmb, int stage);
  TaskStatus SendCosmicRayShear(MeshBlock *pmb, int stage);
  TaskStatus ReceiveCosmicRayShear(MeshBlock *pmb, int stage);
  TaskStatus SendCosmicRayFluxShear(MeshBlock *pmb, int stage);
  TaskStatus ReceiveCosmicRayFluxShear(MeshBlock *pmb, int stage);
  TaskStatus CRScattering(MeshBlock *pmb, int stage);
  TaskStatus SetPropertiesCosmicRay(MeshBlock *pmb, int stage);
...
class SuperTimeStepTaskList : public TaskList {
 public:
  ...
  TaskStatus CalculateCosmicRayFlux_STS(MeshBlock *pmb, int stage);
  ...
  TaskStatus IntegrateCosmicRay_STS(MeshBlock *pmb, int stage);
...
const TaskID SEND_CRSH(53);
const TaskID SEND_CRFLXSH(54);
const TaskID RECV_HYDFLXSH(55);
const TaskID RECV_HYDSH(56);
const TaskID RECV_EMFSH(57);
const TaskID RECV_FLDSH(58);
const TaskID RECV_CRSH(59);
const TaskID RECV_CRFLXSH(60);

const TaskID DIFFUSE_HYD(61);
const TaskID DIFFUSE_FLD(62);

const TaskID CALC_SCLRFLX(64);
const TaskID SEND_SCLRFLX(65);
const TaskID RECV_SCLRFLX(66);
const TaskID INT_SCLR(67);
const TaskID SEND_SCLR(68);
const TaskID RECV_SCLR(69);
const TaskID SETB_SCLR(70);
const TaskID DIFFUSE_SCLR(71);
const TaskID SEND_SCLRFLXSH(72);
const TaskID SEND_SCLRSH(73);
const TaskID RECV_SCLRFLXSH(74);
const TaskID RECV_SCLRSH(75);

const TaskID SEND_HYDORB(76);
const TaskID RECV_HYDORB(77);
const TaskID CALC_HYDORB(78);
const TaskID SEND_FLDORB(79);
const TaskID RECV_FLDORB(80);
const TaskID CALC_FLDORB(81);
const TaskID PROPERTIES_CR(82);
