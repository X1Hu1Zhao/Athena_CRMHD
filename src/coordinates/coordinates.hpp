...
class Coordinates {
 public:
  ...
  virtual void AddCoordTermsDivergenceCosmicRay(const Real dt, const AthenaArray<Real> *cr_flx,
...
class Cylindrical : public Coordinates {
 ...
 public:
  ...
  void AddCoordTermsDivergenceCosmicRay(const Real dt, const AthenaArray<Real> *cr_flx,
                     const AthenaArray<Real> &cr_prim, AthenaArray<Real> &cr_cons) final;
};
...
class SphericalPolar : public Coordinates {
 ...
 public:
  ...
  void AddCoordTermsDivergence_STS(const Real dt, int stage,
                     const AthenaArray<Real> *flux,
                     AthenaArray<Real> &u, AthenaArray<Real> &flux_div) final;
  // ...to compute geometrical source terms on cosmic rays
  void AddCoordTermsDivergenceCosmicRay(const Real dt, const AthenaArray<Real> *cr_flx,
                     const AthenaArray<Real> &cr_prim, AthenaArray<Real> &cr_cons) final;
};
