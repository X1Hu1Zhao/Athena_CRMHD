...
class HydroSourceTerms {
 public:
  ...
  void AddHydroSourceTerms(const Real time, const Real dt, const AthenaArray<Real> *flux,
                           const AthenaArray<Real> &prim, const AthenaArray<Real> &cr_prim,
                           const AthenaArray<Real> &prim_scalar, const AthenaArray<Real> &bcc,
                           AthenaArray<Real> &cons, AthenaArray<Real> &cr_cons,
  ...
  void PolarAveragingHydro(AthenaArray<Real> &cons, int j, int nlayer);
 ...
 private:
  ...
  AthenaArray<Real> hyd_avg_; // storage for polar averaging
