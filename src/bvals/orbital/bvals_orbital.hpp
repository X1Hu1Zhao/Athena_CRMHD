...
class OrbitalBoundaryCommunication {
 ...
 private:
  ...
  void LoadCosmicRayBufferSameLevel(Real *buf, int &p, const int nb);
  void LoadCosmicRayBufferToCoarser(Real *buf, int &p, const int nb);
  void LoadCosmicRayBufferToFiner(Real *buf, int &p, const int nb);
  void SetCosmicRayBufferSameLevel(Real *buf, int &p, const int nb);
  void SetCosmicRayBufferFromCoarser(Real *buf, int &p, const int nb);
  void SetCosmicRayBufferFromFiner(Real *buf, int &p, const int nb);
