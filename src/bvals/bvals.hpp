...
//!   (Hydro, Field, CosmicRay, Passive Scalar, Gravity, etc.). Greedy allocation for worst-case
...
class BoundaryValues : public BoundaryBase, //public BoundaryPhysics,
 ...
 private:
  ...
  // Shearing box (shared with Field, Hydro and CosmicRay)
  ...
  friend class CosmicRayBoundaryVariable;    // needed for shearing box quantities
};
