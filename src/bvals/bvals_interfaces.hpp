...
//! flags to mark which variables are reversed across polar boundary, for cosmic-ray variables
constexpr const bool flip_across_pole_cosmic_ray[]    = {false, false, true, true};
constexpr const bool flip_across_pole_cr_diffusion[] = {false, false, true, true};
//! flags to mark which variables are reversed across polar boundary
