...
//----------------------------------------------------------------------------------------
//! \fn Reconstruction::PiecewiseParabolicX1_CosmicRay(const int k, const int j,
...
void Reconstruction::PiecewiseParabolicX1_CosmicRay(
  ...
  AthenaArray<Real> &q_im2  = scr2_ni_cr_, &q_im1  = scr3_ni_cr_,
                    &q_i    = scr4_ni_cr_, &q_ip1  = scr5_ni_cr_, &q_ip2 = scr6_ni_cr_,
                    &qr_imh = scr7_ni_cr_, &ql_iph = scr8_ni_cr_;

  // set work PPM work arrays to shallow copies of scratch arrays:
  AthenaArray<Real> &dd = scr02_i_cr_, &dd_im1  = scr03_i_cr_, &dd_ip1 = scr04_i_cr_,
                   &dph = scr05_i_cr_, &dph_ip1 = scr06_i_cr_;

  AthenaArray<Real> &d2qc_im1 = scr07_i_cr_, &d2qc = scr08_i_cr_, &d2qc_ip1 = scr09_i_cr_,
                        &d2qf = scr10_i_cr_;

  AthenaArray<Real> &qplus = scr11_i_cr_, &qminus = scr12_i_cr_, &dqf_plus = scr13_i_cr_,
                &dqf_minus = scr14_i_cr_;
...
//-------------------------------------------------------------------------------------
//! \fn Reconstruction::PiecewiseParabolicX2_CosmicRay(const int k, const int j,
//!                              const int il, const int iu,
//!                              const AthenaArray<Real> &w, const AthenaArray<Real> &bcc,
//!                              AthenaArray<Real> &wl, AthenaArray<Real> &wr)
...
void Reconstruction::PiecewiseParabolicX2_CosmicRay(
    const int k, const int j, const int il, const int iu,
    const AthenaArray<Real> &q,
    AthenaArray<Real> &ql, AthenaArray<Real> &qr) {
  const int nu = q.GetDim4() - 1;
  ...
  // set work arrays used for primitive/characterstic cell-averages to scratch
  AthenaArray<Real> &q_jm2  = scr2_ni_cr_, &q_jm1  = scr3_ni_cr_,
                    &q_j    = scr4_ni_cr_, &q_jp1  = scr5_ni_cr_, &q_jp2 = scr6_ni_cr_,
                    &qr_jmh = scr7_ni_cr_, &ql_jph = scr8_ni_cr_;

  // set work PPM work arrays to shallow copies of scratch arrays:
  AthenaArray<Real> &dd = scr02_i_cr_, &dd_jm1  = scr03_i_cr_, &dd_jp1 = scr04_i_cr_,
                   &dph = scr05_i_cr_, &dph_jp1 = scr06_i_cr_;

  AthenaArray<Real> &d2qc_jm1 = scr07_i_cr_, &d2qc = scr08_i_cr_, &d2qc_jp1 = scr09_i_cr_,
                        &d2qf = scr10_i_cr_;
...
//----------------------------------------------------------------------------------------
//! \fn Reconstruction::PiecewiseParabolicX3_CosmicRay(const int k, const int j,
//!                              const int il, const int iu,
//!                              const AthenaArray<Real> &w, const AthenaArray<Real> &bcc,
//!                              AthenaArray<Real> &wl, AthenaArray<Real> &wr)
...
void Reconstruction::PiecewiseParabolicX3_CosmicRay(
    const int k, const int j, const int il, const int iu,
    const AthenaArray<Real> &q,
    AthenaArray<Real> &ql, AthenaArray<Real> &qr) {
  const int nu = q.GetDim4() - 1;
  ...
  // set work arrays used for primitive/characterstic cell-averages to scratch
  AthenaArray<Real> &q_km2  = scr2_ni_cr_, &q_km1  = scr3_ni_cr_,
                    &q_k    = scr4_ni_cr_, &q_kp1  = scr5_ni_cr_, &q_kp2 = scr6_ni_cr_,
                    &qr_kmh = scr7_ni_cr_, &ql_kph = scr8_ni_cr_;

  // set work PPM work arrays to shallow copies of scratch arrays:
  AthenaArray<Real> &dd = scr02_i_cr_, &dd_km1  = scr03_i_cr_, &dd_kp1 = scr04_i_cr_,
                   &dph = scr05_i_cr_, &dph_kp1 = scr06_i_cr_;

  AthenaArray<Real> &d2qc_km1 = scr07_i_cr_, &d2qc = scr08_i_cr_,
                    &d2qc_kp1 = scr09_i_cr_, &d2qf = scr10_i_cr_;
