...
class Reconstruction {
 public:
  ...
  void DonorCellX1_CosmicRay(const int k, const int j, const int il, const int iu,
                             const AthenaArray<Real> &q,
                             AthenaArray<Real> &ql, AthenaArray<Real> &qr);

  void DonorCellX2_CosmicRay(const int k, const int j, const int il, const int iu,
                             const AthenaArray<Real> &q,
                             AthenaArray<Real> &ql, AthenaArray<Real> &qr);

  void DonorCellX3_CosmicRay(const int k, const int j, const int il, const int iu,
                             const AthenaArray<Real> &q,
                             AthenaArray<Real> &ql, AthenaArray<Real> &qr);

  void DonorCellX1_MagneticField(const int k, const int j, const int il, const int iu,
                                 const AthenaArray<Real> &b1, const AthenaArray<Real> &bcc,
                                 AthenaArray<Real> &bl, AthenaArray<Real> &br);

  void DonorCellX2_MagneticField(const int k, const int j, const int il, const int iu,
                                 const AthenaArray<Real> &b2, const AthenaArray<Real> &bcc,
                                 AthenaArray<Real> &bl, AthenaArray<Real> &br);

  void DonorCellX3_MagneticField(const int k, const int j, const int il, const int iu,
                                 const AthenaArray<Real> &b3, const AthenaArray<Real> &bcc,
                                 AthenaArray<Real> &bl, AthenaArray<Real> &br);



  void PiecewiseLinearX1_CosmicRay(const int k, const int j, const int il, const int iu,
                             const AthenaArray<Real> &q,
                             AthenaArray<Real> &ql, AthenaArray<Real> &qr);

  void PiecewiseLinearX2_CosmicRay(const int k, const int j, const int il, const int iu,
                             const AthenaArray<Real> &q,
                             AthenaArray<Real> &ql, AthenaArray<Real> &qr);

  void PiecewiseLinearX3_CosmicRay(const int k, const int j, const int il, const int iu,
                             const AthenaArray<Real> &q,
                             AthenaArray<Real> &ql, AthenaArray<Real> &qr);


  void PiecewiseParabolicX1_CosmicRay(const int k, const int j, const int il, const int iu,
                             const AthenaArray<Real> &q,
                             AthenaArray<Real> &ql, AthenaArray<Real> &qr);

  void PiecewiseParabolicX2_CosmicRay(const int k, const int j, const int il, const int iu,
                             const AthenaArray<Real> &q,
                             AthenaArray<Real> &ql, AthenaArray<Real> &qr);

  void PiecewiseParabolicX3_CosmicRay(const int k, const int j, const int il, const int iu,
                             const AthenaArray<Real> &q,
                             AthenaArray<Real> &ql, AthenaArray<Real> &qr);
 ...
 private:
  ...
  AthenaArray<Real> scr01_i_cr_, scr02_i_cr_, scr03_i_cr_, scr04_i_cr_, scr05_i_cr_;
  AthenaArray<Real> scr06_i_cr_, scr07_i_cr_, scr08_i_cr_, scr09_i_cr_, scr10_i_cr_;
  AthenaArray<Real> scr11_i_cr_, scr12_i_cr_, scr13_i_cr_, scr14_i_cr_;
  AthenaArray<Real> scr1_ni_cr_, scr2_ni_cr_, scr3_ni_cr_, scr4_ni_cr_, scr5_ni_cr_;
  AthenaArray<Real> scr6_ni_cr_, scr7_ni_cr_, scr8_ni_cr_;
