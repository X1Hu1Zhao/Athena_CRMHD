...
class OrbitalAdvection{
 ...
 public:
  ...
  void SetOrbitalAdvectionCC(const AthenaArray<Real> &u, const AthenaArray<Real> &cr_cons, const AthenaArray<Real> &s);
  void SetOrbitalAdvectionFC(const FaceField &b);
  void CalculateOrbitalAdvectionCC(const Real dt, AthenaArray<Real> &u,
                     AthenaArray<Real> &cr_cons, AthenaArray<Real> &s);
  ...
  void ConvertOrbitalSystemCosmicRay(const int cr_id, const AthenaArray<Real> &cr_prim0,
  ...
  AthenaArray<Real> cr_prim_orb, cr_cons_orb; // buffer for orbital advection system output for cosmic rays
 ...
 private:
  ...
  CosmicRay     *cr_pointer;   // ptr to CosmicRay
  ...
  AthenaArray<Real> orbital_cons, orbital_cr_cons, orbital_scalar;
  ...
  AthenaArray<Real> cr_cons_coarse_send, cr_cons_coarse_recv, cr_cons_temp;
  ...
  AthenaArray<Real> crbuf;    // pencil buffer for shallow copy for cosmic-ray calculation
