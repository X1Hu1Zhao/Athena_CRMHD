...
class MeshBlock {
 ...
 public:
  ...
  int nuser_out_var;
  int nuser_out_var_1D;
  int nuser_out_var_2D;
  AthenaArray<Real> user_out_var;
  AthenaArray<Real> user_out_var_1D;
  AthenaArray<Real> user_out_var_2D;
  std::string *user_out_var_names_;
  std::string *user_out_var_names_1D_;
  std::string *user_out_var_names_2D_;
  ...
  void DeepCopy(AthenaArray<Real> &u_out, const AthenaArray<Real> &u_in);
 ...
 private:
  ...
  void AllocateUserOutputVariables1D(int n);
  void AllocateUserOutputVariables2D(int n);
  void SetUserOutputVariableName(int n, const char *name);
  void SetUserOutputVariableName_1D(int n, const char *name);
  void SetUserOutputVariableName_2D(int n, const char *name);
...
class Mesh {
  ...
  friend class CosmicRaySourceTerms;
  friend class CRScattering;
 ...
 private:
  ...
  CRScatteringCoeffFunc CRScatteringCoeff_;
  ...
  void EnrollCRScatteringCoefficients(CRScatteringCoeffFunc my_func);
